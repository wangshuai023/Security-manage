...
public class UserInfoServiceImpl implements UserInfoService {
    ...
    public String update(UserInfo model, LoginModel login) {
        ...
        if (model.getCelPhone() != null) {
            Pattern p = Pattern.compile(
                    "^[1](([3|5|6|7|8|9][\\d])|([4][4,5,6,7,8,9])|([6][2,5,6,7,9])|([7][^9])|([9][1,5,8,9]))[\\d]{8}$");
        ...
        if ((model.getLevels() == null) || model.getLevels().equals("")) {
            return "层级为必填属性";
        }
        if ((model.getBanzu() == null) || model.getBanzu().equals("")) {
            return "班组为必填属性";
        }
        if ((model.getPost() == null) || model.getPost().equals("")) {
            return "职务为必填属性";
        }
        preModel.setRealName(model.getRealName());
        preModel.setCelPhone(model.getCelPhone());
        preModel.setSex(model.getSex());
        preModel.setDepartment(model.getDepartment());
        preModel.setRegion(model.getRegion());
        preModel.setLevels(model.getLevels());
        preModel.setBanzu(model.getBanzu());
        preModel.setPost(model.getPost());
  ...
  */
  ...
  public String add(UserInfo model, LoginModel login) {
      ...
      if (model.getCelPhone() != null) {
          Pattern p = Pattern.compile(
                  "^[1](([3|5|8][\\d])|([4][4,5,6,7,8,9])|([6][2,5,6,7])|([7][^9])|([9][1,5,8,9]))[\\d]{8}$");
          Matcher m = p.matcher(model.getCelPhone());
