...
@Service
public class MeetingGatherServiceImpl implements MeetingGatherService {
    @Autowired
    AdhocMeetingGatherMapper adhocMeetingGatherMapper;
    ...
    */
    ...
    public Map<String, Object> meetingGather(Integer page, LoginModel login,
        ...
        List<Map<String, Object>> list = adhocMeetingGatherMapper.meetingGather(params); //会议统计
