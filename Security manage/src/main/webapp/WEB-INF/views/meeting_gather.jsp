...
<nav class="breadcrumb"><i class="Hui-iconfont"></i>会议统计<a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont"></i></a></nav>
...
<button type="button" onclick="meetingGather();" style="margin-left:30px" class="btn btn-success" ><i class="Hui-iconfont"></i> 查询</button>
