                                                                                            ...
                                                                                            data : {
                                                                                                ...
                                                                                                success : function(result) {
                                                                                                    ...
                                                                                                    for (var i = 0; i < rows.length; i++) {
                                                                                                        ...
                                                                                                        html+='<td>';
                                                                                                        if(rows[i].meetingInfo.orderStatus=='1'){
                                                                                                            html+='<a href="javascript:void(0)" onclick="qx(this)" data-id="'+rows[i].meetingInfo.id+'" act-type="1" class="btn btn-danger  radius btnStyle">取消会议</a>';
                                                                                                        }
                                                                                                        if(rows[i].meetingInfo.orderStatus=='2'||rows[i].meetingInfo.orderStatus=='4'||rows[i].meetingInfo.orderStatus=='5'){
                                                                                                        	html+='<a href="javascript:void(0)" data-url="${pageContext.request.contextPath}/user/meeting_user_info?meetingId='+rows[i].meetingInfo.id+'" page-name="参会人员" onclick="gotoPage(this)"  class="btn btn-success radius btnStyle">参会人员</a>';	
                                                                                                        }
                                                                                                        html+='<a href="${pageContext.request.contextPath}/commonapi/signGather/signGather?mid='+rows[i].meetingInfo.id+'&"  class="btn btn-success radius btnStyle">签到统计</a>';
                                                                                                            html+='</td>';
                                                                                                            html+='</tr>';
                                                                                                        }
                                                                                                        if (rows.length == 0) {
