                                                        ...
                                                        <script type="text/javascript" src="${pageContext.request.contextPath}/static/admin/static/h-ui/js/H-ui.min.js"></script>
                                                            <script type="text/javascript" src="${pageContext.request.contextPath}/static/admin/static/h-ui.admin/js/H-ui.admin.js"></script> <!--/_footer 作为公共模版分离出去-->
                                                                <script type="text/javascript" src="${pageContext.request.contextPath}/static/admin/lib/jquery.contextmenu/jquery.contextmenu.r2.js"></script>
                                                                    ...
                                                                    <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=5148"></script>
                                                                        ...
                                                                        function ajaxList(page) {
                                                                            ...
                                                                            showLoading('${pageContext.request.contextPath}/static/common/loading.gif');
                                                                                $.ajax({
                                                                                    type : 'get',
                                                                                    url : "${pageContext.request.contextPath}/user/room_info/queryList",
                                                                                        data : {
                                                                                        ...
                                                                                        success : function(result) {
                                                                                            ...
                                                                                            for (var i = 0; i < rows.length; i++) {
                                                                                                ...
                                                                                                html+='<td>';
                                                                                                html+='<a href="javascript:void(0)" data-url="${pageContext.request.contextPath}/user/service_info?roomId='+rows[i].roomInfo.id+'" page-name="会议室设备" onclick="gotoPage(this)"  class="btn btn-success radius btnStyle">查看设备</a>';
                                                                                                    html+='<a href="javascript:void(0)" data-url="${pageContext.request.contextPath}/user/meeting_info?roomId='+rows[i].roomInfo.id+'" page-name="会议" onclick="gotoPage(this)"  class="btn btn-success radius btnStyle">会议记录</a>';
                                                                                                        html+='<a href="javascript:void(0)" data-url="${pageContext.request.contextPath}/user/meeting_info/order_meeting?roomId='+rows[i].roomInfo.id+'" page-name="会议" onclick="gotoPage(this)"  class="btn btn-warning radius btnStyle">预约会议室</a>';
                                                                                                            html+='</td>';
                                                                                                            html+='</tr>';
                                                                                                        }
                                                                                                        if (rows.length == 0) {
