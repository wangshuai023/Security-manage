                        ...
                        <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/admin/static/h-ui.admin/skin/green/skin.css" id="skin" />
                            <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/admin/static/h-ui.admin/css/style.css" />
                                ...
                                <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/common/page/myPagination.css?t=4" />
                                    ...
                                    <span style="margin-left:50px;">登录名</span>
                                    <input type="text" class="input-text"  style="width:250px;"  placeholder="请输入登录名进行查询" id="loginName">
                                    </p>
                                    </div>
                                    ...
                                    <input type="text" class="input-text"  style="width:250px;"  placeholder="请输入姓名进行查询" id="realName">
                                    </p>
                                    </div>
                                                    ...
                                                    <script type="text/javascript" src="${pageContext.request.contextPath}/static/admin/static/h-ui/js/H-ui.min.js"></script>
                                                        <script type="text/javascript" src="${pageContext.request.contextPath}/static/admin/static/h-ui.admin/js/H-ui.admin.js"></script> <!--/_footer 作为公共模版分离出去-->
                                                            <script type="text/javascript" src="${pageContext.request.contextPath}/static/admin/lib/jquery.contextmenu/jquery.contextmenu.r2.js"></script>
                                                                ...
                                                                <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=8781"></script>
                                                                                ...
                                                                                url : "${pageContext.request.contextPath}/admin/user_info/queryList",
                                                                                    ...
                                                                                    success : function(result) {
                                                                                        ...
                                                                                        for (var i = 0; i < rows.length; i++) {
                                                                                            ...
                                                                                            html+='<td>'+sexVal+'</td>';
                                                                                            var departmentVal=setNullToEmpty(rows[i].userInfo.department);
                                                                                            html+='<td>'+ departmentVal+'</td>';
                                                                                            var regionVal=setNullToEmpty(rows[i].userInfo.region);
                                                                                            html+='<td>'+ regionVal+'</td>';
                                                                                            var levelsVal=setNullToEmpty(rows[i].userInfo.levels);
                                                                                            html+='<td>'+ levelsVal+'</td>';
                                                                                            var banzuVal=setNullToEmpty(rows[i].userInfo.banzu);
                                                                                            html+='<td>'+ banzuVal+'</td>';
                                                                                            var postVal=setNullToEmpty(rows[i].userInfo.post);
                                                                                            html+='<td>'+ postVal+'</td>';
                                                                                            ...
                                                                                            html+='<a href="${pageContext.request.contextPath}/admin/user_info/update2?id='+rows[i].userInfo.id+'" class="btn btn-primary  radius btnStyle">修改</a>';
                                                                                                html+='</td>';
                                                                                                html+='</tr>';
                                                                                            }
                                                                                            if (rows.length == 0) {
