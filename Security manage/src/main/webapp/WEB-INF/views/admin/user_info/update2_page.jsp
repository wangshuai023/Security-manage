                            ...
                            <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/admin/lib/Hui-iconfont/1.0.8/iconfont.css" />
                                <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/admin/static/h-ui.admin/skin/default/skin.css" id="skin" />
                                    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/admin/static/h-ui.admin/css/style.css" />
                                        ...
                                        <input type="text" class="input-text"  style="width:500px;" value="${data.loginName}" placeholder="请输入登录名（登录名只能为英文或者数字、最长为八位）" id="loginName" maxlength="8" onkeyup="value=value.replace(/[\W]/g,'') "onbeforepaste=”clipboardData.setData(‘text’,clipboardData.getData(‘text’).replace(/[^\d]/g,”))”/>	<span style="color:red">*必填</span>
                                            ...
                                            <div class="formControls col-xs-8 col-sm-9">
                                            <input type="text" class="input-text"  style="width:500px;" value="${data.password}" placeholder="请输入密码（密码只能为英文或数字、最长为八位）" id="password" maxlength="8" onkeyup="value=value.replace(/[\W]/g,'') "onbeforepaste=”clipboardData.setData(‘text’,clipboardData.getData(‘text’).replace(/[^\d]/g,”))”/>	<span style="color:red">*必填</span>
                                                ...
                                                <div class="formControls col-xs-8 col-sm-9">
                                                <input type="text" class="input-text"  style="width:500px;" value="${data.realName}" placeholder="请输入姓名(姓名只能为汉字)" id="realName" onkeyup="value=value.replace(/[^\u4E00-\u9FA5]/g,'')"
                                                    ...
                                                    <div class="formControls col-xs-8 col-sm-9">
                                                    <input type="text" class="input-text"  style="width:500px;" value="${data.celPhone}" placeholder="请输入联系电话" id="celPhone">	<span style="color:red">*必填</span>
                                        ...
                                        <div class="row cl" id="postParentContent" style="margin-top:20px;margin-left:20px;" >
                                            ...
                                            <div class="formControls col-xs-8 col-sm-9">
                                                <input type="text" class="input-text"  style="width:500px;" value="${data.post}" placeholder="请输入现任职务" id="post">	<span style="color:red">*必填</span>
                                                                                ...
                                                                                <script type="text/javascript" src="${pageContext.request.contextPath}/static/admin/lib/layer/2.4/layer.js"></script>
                                                                                    <script type="text/javascript" src="${pageContext.request.contextPath}/static/admin/static/h-ui/js/H-ui.min.js"></script>
                                                                                        <script type="text/javascript" src="${pageContext.request.contextPath}/static/admin/static/h-ui.admin/js/H-ui.admin.js"></script> <!--/_footer /作为公共模版分离出去-->
                                                                                            <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=1857"></script>
                                                                                                ...
                                                                                                function submitData(){
                                                                                                    ...
                                                                                                    $.ajax({
                                                                                                        type: 'post',
                                                                                                        url: '${pageContext.request.contextPath}/admin/user_info/update2_submit',
                                                                                                            data:{
                                                                                                                "id":'${data.id}',
