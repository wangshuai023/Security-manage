                        ...
                        <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/admin/static/h-ui.admin/skin/green/skin.css" id="skin" />
                            <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/admin/static/h-ui.admin/css/style.css" />
                                ...
                                <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/common/page/myPagination.css?t=4" />
                                    ...
                                    <nav class="breadcrumb"><i class="Hui-iconfont"></i>会议室设备<a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont"></i></a></nav>
                                    <div class="page-container">
                                    
                                    
                                    <div class="cl pd-5 bg-1 bk-gray mt-20">
                                    <span class="l" id="globalBtns">
                                    <a href="${pageContext.request.contextPath}/admin/service_info/add?roomId=${data.roomId}" class="btn btn-success radius">新增</a>
                                        ...
                                        <tbody id="service_info_body">
                                        </tbody>
                                        </table>
                                        
                                        <div id="service_info_bar" class="pagination" style="margin-top:20px;">
                                        </div>
                                        <div>
                                        </div>
                                        </div>
                                                    ...
                                                    <script type="text/javascript" src="${pageContext.request.contextPath}/static/admin/static/h-ui/js/H-ui.min.js"></script>
                                                        <script type="text/javascript" src="${pageContext.request.contextPath}/static/admin/static/h-ui.admin/js/H-ui.admin.js"></script> <!--/_footer 作为公共模版分离出去-->
                                                            <script type="text/javascript" src="${pageContext.request.contextPath}/static/admin/lib/jquery.contextmenu/jquery.contextmenu.r2.js"></script>
                                                                ...
                                                                <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=5144"></script>
                                                                    ...
                                                                    function ajaxList(page) {
                                                                        ...
                                                                        showLoading('${pageContext.request.contextPath}/static/common/loading.gif');
                                                                            $.ajax({
                                                                                type : 'get',
                                                                                url : "${pageContext.request.contextPath}/admin/service_info/queryList",
                                                                                    data : {
                                                                                        "roomId":"${data.roomId}",
                                                                                        ...
                                                                                        success : function(result) {
                                                                                            ...
                                                                                            for (var i = 0; i < rows.length; i++) {
                                                                                                html += '<tr>' ;
                                                                                                var serviceNameVal=setNullToEmpty(rows[i].serviceInfo.serviceName);
                                                                                                html+='<td>'+ serviceNameVal+'</td>';
                                                                                                var roomIdVal=setNullToEmpty(rows[i].roomIdStr);
                                                                                                html+='<td>'+ roomIdVal+'</td>';
                                                                                                html+='<td>';
                                                                                                html+='<a href="${pageContext.request.contextPath}/admin/service_info/update?id='+rows[i].serviceInfo.id+'&roomId=${data.roomId}" class="btn btn-primary  radius btnStyle">修改</a>';
                                                                                                    html+='<a href="javascript:void(0)" onclick="del(this)" data-id="'+rows[i].serviceInfo.id+'" class="btn btn-danger  radius btnStyle">删除</a>';
                                                                                                    html+='</td>';
                                                                                                    html+='</tr>';
                                                                                                }
                                                                                                if (rows.length == 0) {
                                                                                    ...
                                                                                    function del(e){
                                                                                        if(window.confirm('你确定要删除该会议室设备吗')){
                                                                                            var id = $(e).attr("data-id");
                                                                                            $.ajax({
                                                                                                type : 'get',
                                                                                                url : "${pageContext.request.contextPath}/admin/service_info/del",
                                                                                                    data : {
                                                                                                        "id":id
                                                                                                    },
                                                                                                    success : function(result) {
