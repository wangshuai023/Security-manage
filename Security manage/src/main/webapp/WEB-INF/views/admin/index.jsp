...
<header class="navbar-wrapper">
	<div class="navbar navbar-fixed-top">
		<div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="#">轨梁厂安全网格化智能管控系统</a>
...
<dd style="display: block;"> 
 ...
 <li>
  ...
  <a   href="javascript:void(0)" data-href="${pageContext.request.contextPath}/admin/meeting_info" data-title="会议管理" title="会议管理"> 
会议管理 
</a>
...
<dd style="display: block;"> 
 ...
 <li>
  ...
  <a   href="javascript:void(0)" data-href="${pageContext.request.contextPath}/admin/sys_setting_info" data-title="系统设置" title="系统设置"> 
系统设置 
</a>
...
<dd style="display: block;"> 
 <ul>
	 ...
	 <li>
		 ...
		 <a   href="javascript:void(0)" data-href="${pageContext.request.contextPath}/commonapi/meetingGather/meetingGather" data-title="会议统计" title="会议统计">
			 违章统计
		 </a>
