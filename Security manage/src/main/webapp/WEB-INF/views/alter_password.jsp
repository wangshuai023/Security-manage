...
<div class="formControls col-xs-8 col-sm-9">
<input type="password" class="input-text"  placeholder="请输入新密码（密码只能为英文或数字、最长为八位）" id="password2" name="password2"maxlength="8" onkeyup="value=value.replace(/[\W]/g,'') "onbeforepaste=”clipboardData.setData(‘text’,clipboardData.getData(‘text’).replace(/[^\d]/g,”))”/>
</div>
</div>
 <div class="row cl"  id="nameParentDiv" style="margin-top:20px;margin-left:20px;" > 	<label class="form-label col-xs-4 col-sm-2">新密码
</label>
<div class="formControls col-xs-8 col-sm-9">
<input type="password" class="input-text"  placeholder="请再次输入新密码（密码只能为英文或数字、最长为八位）" id="password3" name="password3"maxlength="8" onkeyup="value=value.replace(/[\W]/g,'') "onbeforepaste=”clipboardData.setData(‘text’,clipboardData.getData(‘text’).replace(/[^\d]/g,”))”/>
</div>
</div>
</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/admin/icheck/jquery.icheck.min.js"></script>
